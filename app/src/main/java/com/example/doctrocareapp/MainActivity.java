...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText emailText, passwordText, passwordConf, confirm;
...
//       mGoogleSignInClient = GoogleSignIn.getClient(this, gso);
        ...
        confirm = (EditText) findViewById(R.id.passwordConfText);
...
//        textView.setText("Or Sign in with Google");
        ...
        passwordConf = (EditText) findViewById(R.id.passwordConfText);
